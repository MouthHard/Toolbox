...
const ToolCard: React.FC<ToolCardProps> = ({
  ...
  const handleUpdateFavorites = useCallback(
    (selectedFolders: Array<string | 'favorite'>) => {
  ...
  const iconContent = useMemo(() => {
    if (tool.svgIcon?.trim()) {
      const sanitizedSVG = sanitizeHTML(tool.svgIcon, {
      ...
      <div className="tool-card-link">
        <div className="tool-card">
          ...
          <div className="tool-top-section">
            <div className="tool-icon-wrapper">{iconContent}</div>
          ...
          <div className="tool-card-footer">
            ...
            <button className="visit-button" onClick={handleOpenConfirm} type="button">
